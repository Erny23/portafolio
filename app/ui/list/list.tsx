        ...
        <>
            <section className="flex flex-col justify-center items-center px-6 py-3 sm:flex-row sm:justify-between sm:py-6">
                ...
                <ul className="flex gap-3">
                    ...
                    <li>
                        <button className={`${selected === "design" ? "text-complementary font-semibold" : null}`} onClick={() => setSelected("design")}>Diseños</button>
                    </li>
                    <li>
                        {/*<button className={`${selected === "photos" ? "text-complementary font-semibold" : null}`} onClick={() => setSelected("code")}>Código</button>*/}
                        <button className="text-gray-400 cursor-not-allowed">Código</button>
                    </li>
                    <li>
                        {/*<button className={`${selected === "others" ? "text-complementary font-semibold" : null}`} onClick={() => setSelected("others")}>Otros</button>*/}
                        <button className="text-gray-400 cursor-not-allowed">Otros</button>
                    </li>
                </ul>
            </section>
            ...
            <section className="container mx-auto px-4">
                <div className="grid grid-rows-5 grid-cols-2 gap-10">
                    <div className={`${selected === "design" || selected === "all" ? `${style.block}` : `${style.hidden}`} row-span-1`}>
                    ...
                    <div className={`${selected === "design" || selected === "all" ? `${style.block}` : `${style.hidden}`} row-span-2`}>
                    ...
                    <div className={`${selected === "design" || selected === "all" ? `${style.block}` : `${style.hidden}`} row-span-3`}>
